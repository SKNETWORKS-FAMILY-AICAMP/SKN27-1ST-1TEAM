...
- **팀원4**: 
- **팀원5**:
- **27기_한재웅**: 이번 첫 프로젝트를 통해서 단순한 통계 데이터를 이용하여 유의미한 분석 결과를 도출하는데 대한 직접적인 협업 경험을 할 수 있어 좋았습니다.  앞으로도 이번 프로젝트 경험을 바탕으로 다양한 데이터를 수집하고 분석하는데 개인적으로 더 많은 역할을 할 수 있다면 좋을 것 같습니다.
