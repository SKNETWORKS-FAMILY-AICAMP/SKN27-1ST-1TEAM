...
# 9. 한 줄 회고
- **팀원1**: 데이터를 시각화하며 친환경차 시대를 체감할 수 있었습니다.
- **팀원2**: 데이터베이스와 앱 간의 유기적인 연동 과정을 배울 수 있었습니다.
- **팀원3**: 복잡한 수치 데이터를 직관적인 그래프로 표현하는 즐거움을 알게 되었습니다.
- **팀원4**: 사용자 관점에서 어떤 정보가 가장 필요할지 고민하며 프로젝트에 임했습니다.
- **팀원5**: 프로젝트 전반의 기술 스레드를 관리하며 협업의 가치를 느꼈습니다.
